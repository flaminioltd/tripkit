...
export const FINANCE_MODULES: RedesignModuleProps[] = [
  ...
  { id: 'vatRefund', title: 'VAT Refund', category: 'Finance', CustomIcon: VatRefundIcon, fallbackIcon: 'receipt-long', route: '/modules/vat-refund', backgroundColor: '#FFF3B8', color: tokens.colors.text.primary },
  { id: 'budgetTracker', title: 'Budget Tracker', category: 'Finance', CustomIcon: BudgetIcon, fallbackIcon: 'savings', route: '/modules/budget-tracker', backgroundColor: '#E2F7DE', color: tokens.colors.text.primary },
...
export const ESSENTIALS_MODULES: RedesignModuleProps[] = [
  { id: 'sizeConverter', title: 'Sizes & Units', category: 'Essentials', CustomIcon: SizeGuideIcon, fallbackIcon: 'straighten', route: '/modules/size-converter', backgroundColor: '#F2E2B8', color: tokens.colors.text.primary },
  ...
  { id: 'localInfo', title: 'Local Info', category: 'Essentials', CustomIcon: LocalInfoIcon, fallbackIcon: 'info', route: '/modules/local-info', backgroundColor: '#F2F2F0', color: tokens.colors.text.primary },
];
