...
export const FINANCE_MODULES: RedesignModuleProps[] = [
  ...
  { id: 'vatRefund', title: 'VAT Refund', category: 'Finance', CustomIcon: VatRefundIcon, fallbackIcon: 'receipt-long', route: '/modules/vat-refund', backgroundColor: '#fbede9', color: tokens.colors.text.primary, isPremium: true },
  { id: 'budgetTracker', title: 'Budget Tracker', category: 'Finance', CustomIcon: BudgetIcon, fallbackIcon: 'savings', route: '/modules/budget-tracker', backgroundColor: '#c9e0e5', color: tokens.colors.text.primary, isPremium: true },
  { id: 'atmExchange', title: 'ATM & Exchange', category: 'Finance', CustomIcon: AtmExchangeIcon, fallbackIcon: 'local-atm', route: '/modules/atm-exchange', backgroundColor: '#EDE4F5', color: tokens.colors.text.primary, isPremium: true },
];
...
export const ESSENTIALS_MODULES: RedesignModuleProps[] = [
  ...
  { id: 'timezoneHelper', title: 'Time Zones', category: 'Essentials', CustomIcon: TimeZoneIcon, fallbackIcon: 'schedule', route: '/modules/timezone-helper', backgroundColor: '#E4F0FF', color: tokens.colors.text.primary, isPremium: true },
